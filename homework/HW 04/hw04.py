...
def balanced(m):
    ...
    left_balanced = not is_mobile(left_end) or balanced(left_end)
    right_balanced = not is_mobile(right_end) or balanced(right_end)
...
def max_path_sum(t):
    ...
    def helper(t, curr):
        ...
        if is_leaf(t):
            ...
            label_val = label(t)
            for t_b in branches(t):
                helper(t_b, curr + label_val)
